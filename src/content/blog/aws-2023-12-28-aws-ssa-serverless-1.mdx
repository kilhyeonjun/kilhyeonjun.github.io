...
description: "AWS 서버리스 아키텍처의 핵심인 Lambda, CloudFront Functions, Lambda@Edge의 개념과 사용 사례를 정리합니다. VPC 내 Lambda 실행과 RDS Proxy 활용법도 다룹니다."
...
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/aws/ssa-18-1-serverless/"
---
...
![Serverless in AWS](../../assets/images/legacy/aws/ssa_serverless_in_aws.webp)
...
![CloudFront Functions](../../assets/images/legacy/aws/ssa_cloudfront_functions.webp)
...
![Lambda@Edge](../../assets/images/legacy/aws/ssa_lambda_at_edge.webp)
...
![CloudFront Functions vs Lambda@Edge](../../assets/images/legacy/aws/ssa_cloudfront_functions_vs_lambda_at_edge.webp)
...
![Lambda Default VPC](../../assets/images/legacy/aws/ssa_default_lambda_dev.webp)
...
![Lambda in VPC](../../assets/images/legacy/aws/ssa_lambda_in_vpc.webp)
...
![Invoking Lambda from RDS](../../assets/images/legacy/aws/ssa_invoke_lambda_in_rds.webp)
...
![RDS Event Notifications](../../assets/images/legacy/aws/ssa_rds_event_noti.webp)
