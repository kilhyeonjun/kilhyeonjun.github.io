...
![Serverless in AWS](/images/legacy/aws/ssa_serverless_in_aws.png)
...
![CloudFront Functions](/images/legacy/aws/ssa_cloudfront_functions.png)
...
![Lambda@Edge](/images/legacy/aws/ssa_lambda_at_edge.png)
...
![CloudFront Functions vs Lambda@Edge](/images/legacy/aws/ssa_cloudfront_functions_vs_lambda_at_edge.png)
...
![Lambda Default VPC](/images/legacy/aws/ssa_default_lambda_dev.png)
...
![Lambda in VPC](/images/legacy/aws/ssa_lambda_in_vpc.png)
...
![Invoking Lambda from RDS](/images/legacy/aws/ssa_invoke_lambda_in_rds.png)
...
![RDS Event Notifications](/images/legacy/aws/ssa_rds_event_noti.png)
