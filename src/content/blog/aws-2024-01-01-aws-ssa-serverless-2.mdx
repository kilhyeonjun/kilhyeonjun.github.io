...
![DynamoDB Accelerator](/images/legacy/aws/ssa_dax.png)
...
![DAX vs ElastiCache](/images/legacy/aws/ssa_dax_vs_ecache.png)
...
![DynamoDB Global Tables](/images/legacy/aws/ssa_dynamodb_global_tables.png)
