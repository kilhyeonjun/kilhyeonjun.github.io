...
description: "Amazon DynamoDB의 기본 개념, Read/Write Capacity Modes, DAX 캐시, 스트림 처리, Global Table, TTL, 백업 및 S3 통합에 대해 정리합니다."
...
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/aws/ssa-18-2-serverless/"
---
...
![DynamoDB Accelerator](../../assets/images/legacy/aws/ssa_dax.webp)
...
![DAX vs ElastiCache](../../assets/images/legacy/aws/ssa_dax_vs_ecache.webp)
...
![DynamoDB Global Tables](../../assets/images/legacy/aws/ssa_dynamodb_global_tables.webp)
