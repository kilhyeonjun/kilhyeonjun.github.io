---
title: "Git 기본 명령어"
description: "- 분산 버전 관리 시스템 - git으로 관리하는 프로젝트를 올려 둘 수 있는 사이트 - git init 명령어로 생성되는 디렉토리(폴더) - commit, commit을 구성하는 객체, 스테이지가 저장됨 - 로컬 저장소를 upload하는 곳 ex) GitHub - 워"
publishDate: 2021-09-11
category: "Git"
tags: ["Git", "github"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/git/2021-09-11-git-base/"
---
