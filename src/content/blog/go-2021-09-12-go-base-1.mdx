---
title: "Go 기본 명령어 (1)"
description: "※ Go 1.16 버전 부터 모듈 방식이 기본 옵션이 되어서 모든 Go 코드는 Go 모듈 안에 있어야 합니다. !img   위에 사진과 같이 go.mod라는 모듈 파일이 생성됩니다. !img   위에 사진과 같이 [폴더명].exe 실행 파일이 생성됩니다. - exe파일"
publishDate: 2021-09-12
category: "Go"
tags: ["Go"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/go/2021-09-12-go-base-1/"
---
...
~~~
![img](../../assets/images/legacy/go/init.webp)  
...
go build
~~~
![img](../../assets/images/legacy/go/build.webp)  
...
~~~
![img](../../assets/images/legacy/go/print.webp)  
...
~~~
![img](../../assets/images/legacy/go/math.webp)  
...
~~~
![img](../../assets/images/legacy/go/title.webp)
