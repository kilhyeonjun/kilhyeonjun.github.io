---
title: "Go 기본 명령어 (2)"
description: "!img   - fmt 모듈의 Printf 메소드 이용 - reflect 모듈의 TypeOf 메소드 이용 !img - int, float64, rune 등 숫자형 자료형은 초기값이 0 - bool 논리형 자료형은 초기값이 false - string 문자형 자료형은 초기"
publishDate: 2021-09-13
category: "Go"
tags: ["Go"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/go/2021-09-12-go-base-2/"
---
...
~~~
![img](../../assets/images/legacy/go/zerovalue.webp)
...
~~~
![img](../../assets/images/legacy/go/replace.webp)
...
~~~
![img](../../assets/images/legacy/go/read.webp)
...
~~~
![img](../../assets/images/legacy/go/err.webp)
- 위에 결과는 if 문이 없을 때
- 아래 결과는 if 문이 있을 때
...
~~~
![img](../../assets/images/legacy/go/parseInt.webp)
...
~~~
![img](../../assets/images/legacy/go/gugudan.webp)
...
~~~
![img](../../assets/images/legacy/go/sosu.webp)
