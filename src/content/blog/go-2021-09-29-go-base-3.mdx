---
title: "Go 함수"
description: "- 반복되는 코드를 묶어서 실행하는 코드 블럭의 단위입니다. - func 키워드를 사용하여 함수를 정의합니다. - 파라미터명 뒤에 파라미터의 자료형을 정의 합니다. - return type은 함수명 뒤에 적습니다. - 소수 판별 함수 - 구간별 소수 판별 함수 - ma"
publishDate: 2021-09-29
category: "Go"
tags: ["Go"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/go/2021-09-29-go-base-3/"
---
