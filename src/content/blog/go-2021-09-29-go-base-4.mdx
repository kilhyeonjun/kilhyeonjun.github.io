---
title: "Go 패키지"
description: "- 코드의 모듈화, 코드의 재사용을 위해 사용 - 작은 단위의 컴포넌트를 작성 - 보통 패키지는 라이브러리로 사용되지만 - main 패키지는 컴파일러에 의해 실행 프로그램이 된다. - MyAbs 절대값 함수 - MyPower 거듭제곱 함수"
publishDate: 2021-09-29
category: "Go"
tags: ["Go"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/go/2021-09-29-go-base-4/"
---
