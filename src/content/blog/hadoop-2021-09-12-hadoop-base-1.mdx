...
# VirtualBox 설치
![img](/images/legacy/hadoop/vbdown.PNG)
...
![img](/images/legacy/hadoop/memory.PNG)
- 메모리 2GB
  - 하둡을 이용할려면 2GB 정도 필요
...
# Ubuntu 설치
![img](/images/legacy/hadoop/ubuntudown.png)
...
![img](/images/legacy/hadoop/disk.png)
...
- 사용자 입력
- 설치가 완료되면 다시시작  
![img](/images/legacy/hadoop/net.png)
