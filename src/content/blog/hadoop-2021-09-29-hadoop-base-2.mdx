...
description: "본 게시물은 윈도우 환경에서 진행하였습니다. - 우분투 터미널 실행 - core-site.xml 파일 수정 - “localhost:62350”은 분산 컴퓨팅을 구현 시 master의 IP와 Port가 된다. - dfs.replication value가 1이면 싱글 모드"
publishDate: 2021-09-29
category: "Hadoop"
tags: ["Hadoop"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/hadoop/2021-09-29-hadoop-base-2/"
---
