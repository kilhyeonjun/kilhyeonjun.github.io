...
description: "해당 게시물은 이 강의를 보고 제작하게되었습니다. - my.ini 파일에 해당위치에 추가 - 시스템 언어 utf-8로 변경 하기 위함 - MySQL 재시작 !img - show variables like 'c%'; - 해당 쿼리 실행해서 user 생성 및 권한 주기 -"
publishDate: 2021-09-15
category: "Spring Boot"
tags: ["Java", "Spring Boot", "blog"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/java/2021-09-15-springboot-blog-3/"
---
...
## 2. 한글 설정 확인
![img](../../assets/images/legacy/java/springboot/mysqlutf8.webp)
