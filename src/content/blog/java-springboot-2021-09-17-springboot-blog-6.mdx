...
description: "해당 게시물은 이 강의를 보고 제작하게되었습니다. - web.xml, root-context.xml, servlet-context.xml의 합본 - application.yml - .jsp 경로를 설정한 이유는 스프링 부트는 기본적으로 jsp사용이 권장하기 않기 때문에"
publishDate: 2021-09-16
category: "Spring Boot"
tags: ["Java", "Spring Boot", "blog"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/java/2021-09-17-springboot-blog-6/"
---
...
![img](../../assets/images/legacy/java/springboot/openinview.webp)
...
### show-sql: true
![img](../../assets/images/legacy/java/springboot/showsql.webp)
