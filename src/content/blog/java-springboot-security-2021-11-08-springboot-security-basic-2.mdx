...
description: "Spring Security에서 인증되지 않은 요청을 로그인 페이지로 연결하고 권한별 접근 경로를 구성하는 과정을 정리했습니다."
publishDate: 2021-11-07
category: "Spring Boot"
tags: ["Java", "Spring Boot", "Spring Security"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/java/2021-11-08-springboot-security-basic-2/"
---
