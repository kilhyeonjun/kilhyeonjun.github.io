...
description: "Node.js Express 환경에서 JWT(Json Web Token)를 활용한 회원가입, 로그인, 인증 구현 방법을 코드와 함께 정리합니다."
publishDate: 2022-05-18
category: "Node.js"
tags: ["Node.js", "JWT", "Express"]
draft: false
source: "gatsby"
originalUrl: "https://kilhyeonjun.github.io/node.js/jwt-auth/"
---
...
![JWT 구조](../../assets/images/legacy/nodejs/jwt.webp)
![JWT Encoded](../../assets/images/legacy/nodejs/jwt_encoded.webp)
