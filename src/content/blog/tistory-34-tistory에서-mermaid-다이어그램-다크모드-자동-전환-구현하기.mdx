...
description: "> \"pronist/hello 스킨과 완벽하게 동기화되는 Mermaid 다이어그램 만들기\" 기술 블로그를 운영하다 보면 다이어그램은 필수입니다. 복잡한 아키텍처를 설명하거나 플로우차트를 그릴 때 Mermaid만큼 편리한 도구도 없죠.하지만 다크모드가 대세가 된 지금, 한 가지 문제가 있었습니다: 특히 Tistory + pronist/hello 스킨을 사용하"
