---
title: "TSBM 7월 밋업 후기"
description: "최근에 토스 본사에서 열린 TypeScript Backend Meetup #7에 다녀왔습니다. 혹시 TSBM을 처음 들어보시는 분들을 위해 간단히 소개하면, TypeScript Backend Meetup의 줄임말로 TypeScript 기반 백엔드 개발자들의 커리어 성장과 네트워킹을 위한 정기 모임입니다. 매월 개최되며, 실무 경험을 바탕으로 한 기술 발표와"
