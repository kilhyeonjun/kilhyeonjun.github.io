...
![멀티 스레드 환경에서 동시성 제어 방식 분석 대표 이미지](/images/tistory/8/img.webp)
...
-   synchronized: 100번 호출에 대한 시간 41.9s
    ...
    ![](/images/tistory/8/img_2.webp)

-   ReentrantLock: 100번 호출에 대한 시간 41.3s

    ![](/images/tistory/8/img_3.webp)

-   ConcurrentHashMap: 100번 호출에 대한 시간 42.6s

    ![](/images/tistory/8/img_4.webp)
...
-   synchronized: 100번 호출에 대한 시간 40.6s
    ...
    ![](/images/tistory/8/img_5.webp)

-   ReentrantLock: 100번 호출에 대한 시간 44.1s

    ![](/images/tistory/8/img_6.webp)

-   ConcurrentHashMap: 100번 호출에 대한 시간 7.3s

    ![](/images/tistory/8/img_7.webp)
