...
description: "노디패 스터디 6주차! Node.js의 꽃이라고 불리는 스트림을 정리했습니다. 대용량 데이터를 메모리 걱정 없이 다루는 방법과 파이프라인 패턴으로 효율적인 데이터 처리 엔진을 구축하는 과정을 담았습니다."
...
노디패 스터디 6주차! 지난 5장에서 **Promise와 async/await**로 비동기 제어 흐름의 우아함을 배웠다면, 이번 6장에서는 Node.js의 진정한 꽃이라 불리는 **스트림(Stream)**을 깊이 있게 다룹니다.
